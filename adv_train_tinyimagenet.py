...
parser.add_argument('--data', type=str, default='/home/yuqi/data/tiny-imagenet-200/', help='location of the data corpus')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        if valid_acc > best_acc:
            best_acc = valid_acc
            utils.save(model, '/home/yuqi/LW/models_tinyimagenet/model_adv.pt')
            print('save model! ')
